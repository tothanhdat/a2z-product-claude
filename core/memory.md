...
- **Trigger fields không support Expression (kéo variable):** Các field trong Trigger node KHÔNG support kéo mapped variable / expression vì không có step nào phía trước. Tất cả field của Trigger chỉ nhận Static Value. Khi viết Inputs section cho Trigger, cột Expression luôn là `No`.
---
